        ...
        for(var i in posts){
          requestGet('/api/user/get_user',
            ...
            if(res2.statusCode == 200) {
              ...
              ContentCard card = ContentCard(title: i['title'], content: i['content'], postId: i['postId'],avatar: body2['content']['userAvatar'],username: body2['content']['userName'],userId: body2['content']['userId'],media_urls: i['urls'].cast<String>(),type: 'home',);
              setState(() {
